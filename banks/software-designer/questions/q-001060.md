...
```java
    ...
    public void takeOrder(_（3）__ Order){  orderList.add(order);    }
    public void placeOrders(){
    for (__（4）_____ order : orderList) { order.execute(); }
    orderList.clear();
    }
    }
...
![题目图片](../assets/d7f102b2ce12fa6e0540477f3d63b7e6fac0598e0d28d81fa41bba52d9fd8412.jpg)
